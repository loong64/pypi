...
| chroma-hnswlib       | `pip install chroma-hnswlib -i https://mirrors.loong64.com/pypi/simple`       |
| contourpy            | `pip install contourpy -i https://mirrors.loong64.com/pypi/simple`            |
| couchbase            | `pip install couchbase -i https://mirrors.loong64.com/pypi/simple`            |
| crc32c               | `pip install crc32c -i https://mirrors.loong64.com/pypi/simple`               |
...
| google-crc32c        | `pip install google-crc32c -i https://mirrors.loong64.com/pypi/simple`        |
...
| grpcio-tools         | `pip install grpcio-tools -i https://mirrors.loong64.com/pypi/simple`         |
...
| numexpr              | `pip install numexpr -i https://mirrors.loong64.com/pypi/simple`              |
...
| mmh3                 | `pip install mmh3 -i https://mirrors.loong64.com/pypi/simple`                 |
| mysqlclient          | `pip install mysqlclient -i https://mirrors.loong64.com/pypi/simple`          |
| numba                | `pip install numba -i https://mirrors.loong64.com/pypi/simple`                |
...
| opendal              | `pip install opendal -i https://mirrors.loong64.com/pypi/simple`              |
...
| ormsgpack            | `pip install ormsgpack -i https://mirrors.loong64.com/pypi/simple`            |
...
| PyMuPDF              | `pip install PyMuPDF -i https://mirrors.loong64.com/pypi/simple`              |
| PyNaCl               | `pip install PyNaCl -i https://mirrors.loong64.com/pypi/simple`               |
| pypdfium2            | `pip install pypdfium2 -i https://mirrors.loong64.com/pypi/simple`            |
...
| pyzstd               | `pip install pyzstd -i https://mirrors.loong64.com/pypi/simple`               |
...
| xxhash               | `pip install xxhash -i https://mirrors.loong64.com/pypi/simple`               |
| ujson                | `pip install ujson -i https://mirrors.loong64.com/pypi/simple`                |
